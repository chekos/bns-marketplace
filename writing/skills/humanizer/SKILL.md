...
> **Source & attribution.** The AI-writing patterns in this skill are derived from [Wikipedia: Signs of AI writing](https://en.wikipedia.org/wiki/Wikipedia:Signs_of_AI_writing), available under [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/). Adaptations here are shared under the same license.
