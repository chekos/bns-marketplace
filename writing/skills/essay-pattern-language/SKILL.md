...
> **Source & attribution.** Based on Michael Dean's *Pattern Language* framework for essays, which builds on Christopher Alexander's *A Pattern Language* (1977). Patterns and terminology are adapted from that work.
