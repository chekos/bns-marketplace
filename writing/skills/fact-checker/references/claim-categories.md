...
How to identify and categorize verifiable claims in a draft.
...
- Study references: "according to a study", "research shows"
...
- Paraphrased statements: "X said that...", "according to X..."
...
### Verification Method
1. **Direct quotes** → Web search to find original source. Verify the wording literally — AI-assisted drafts often compress an author's argument into a snappy phrase that reads like a verbatim quote but isn't.
...
- Fake-verbatim quotes (paraphrase punctuated as direct quote)
...
Research about LLMs and AI capabilities has a short half-life. Failure modes that were true 6+ months ago may not reflect current models. Before using older AI/ML research as central evidence in a piece, verify whether the failure mode still reproduces against current models — and date-stamp the claim if you keep it.
